...
milkymapper: raylib
ifneq (,$(milkymapper_config))
	@echo "==== Building milkymapper ($(milkymapper_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f milkymapper.make config=$(milkymapper_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f milkymapper.make clean
